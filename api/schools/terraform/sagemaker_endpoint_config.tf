resource "aws_sagemaker_endpoint_configuration" "school_district_endpoint_config_v1_0_8" {
  name = "${var.sagemaker_endpoint_name}-config-v1-0-8"

  production_variants {
    variant_name           = "AllTraffic"
    model_name             = aws_sagemaker_model.school_district_model_v1_0_8.name
